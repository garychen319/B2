...
Item {
  ...
  function validCard(cardId){
    ...
    var cardmap = {"3C": 1, "3D": 2, "3H": 3, "3S": 4, "4C": 5, "4D": 6, "4H": 7, "4S": 8,
                   "5C": 9, "5D": 10, "5H": 11, "5S": 12, "6C": 13, "6D": 14, "6H": 15, "6S": 16,
                   "7C": 17, "7D": 18, "7H": 19, "7S": 20, "8C": 21, "8D": 22, "8H": 23, "8S": 24,
                   "9C": 25, "9D": 26, "9H": 27, "9S": 28, "10C": 29, "10D": 30, "10H": 31, "10S": 32,
                   "JC": 33, "JD": 34, "JH": 35, "JS": 36, "QC": 37, "QD": 38, "QH": 39, "QS": 40,
                   "KC": 41, "KD": 42, "KH": 43, "KS": 44, "AC": 45, "AD": 46, "AH": 47, "AS": 48,
                   "2C": 49, "2D": 50, "2H": 51, "2S": 52}

    var cardval = card.variationType + card.cardColor
    var currval = current.variationType + current.cardColor

    //print("cardval", cardmap[cardval])
    //print("currval", cardmap[currval])
    if (cardmap[cardval] > cardmap[currval]) return true
    else return false
    /*
